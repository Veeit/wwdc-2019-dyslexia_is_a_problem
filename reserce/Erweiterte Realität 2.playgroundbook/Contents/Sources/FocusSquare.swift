...
class FocusSquare: SCNNode {
    ...
    /// - localizationKey: FocusSquare.lastPosition
    ...
    /// - localizationKey: FocusSquare.hide()
    func hide() {
    ...
    /// - localizationKey: FocusSquare.unhide()
    func unhide() {
    ...
    /// - localizationKey: FocusSquare.displayAsBillboard()
    ...
    /// - localizationKey: FocusSquare.displayAsOpen(at:camera:)
    ...
    /// - localizationKey: FocusSquare.displayAsClosed(at:planeAnchor:camera:)
    ...
    /// - localizationKey: FocusSquare.updateTransform(for:camera:)
    ...
    /// - localizationKey: FocusSquare.displayNodeHierarchyOnTop(_:)
    func displayNodeHierarchyOnTop(_ isOnTop: Bool) {
        // Recursively traverses the node’s children to update the rendering order depending on the `isOnTop` parameter.
