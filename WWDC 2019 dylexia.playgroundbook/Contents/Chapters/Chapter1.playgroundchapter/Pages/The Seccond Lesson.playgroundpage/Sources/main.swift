...
//        view.addBackground()
        ...
        recognizer.recognize(image) {
            ...
            case .success(let prediction):
                ...
                if isTeacherActive == true {
                    testLetter(input: "A", letter: predictionLetter)
                }
    ...
    func testLetter(input: String, letter: String) {
        if input == letter {
            resultLetterView.text = "Correct"
        } else {
            resultLetterView.text = "Letter: \(letter)"
        }
    }
    
}

public func addCanvas() {
